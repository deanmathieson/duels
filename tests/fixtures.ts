...
export const fixtureCards: CardDef[] = [
  ...
  // --- deathrattle-archetype fixtures ---
  {
    id: 'egg_fix',
    name: 'Cracked Egg',
    cost: 2,
    ...
    attack: 0,
    health: 2,
    deathrattle: [{ kind: 'summon', token: 'treant', count: 1 }],
  },
  {
    id: 'baron_fix',
    name: 'Fixture Baron',
  ...
  {
    id: 'resummon_dr_spell',
    name: 'Unearth',
    cost: 2,
    type: 'spell',
    cardClass: 'neutral',
    rarity: 'common',
    text: 'Resummon a friendly Deathrattle minion that died this game.',
    spell: [{ kind: 'resummonDeadMinion', count: 1, filter: 'deathrattle' }],
  },
  {
    id: 'resummon_all_spell',
    name: 'Mass Exhumation',
    cost: 5,
    type: 'spell',
    cardClass: 'neutral',
    rarity: 'common',
    text: 'Resummon 2 friendly minions that died this game.',
    spell: [{ kind: 'resummonDeadMinion', count: 2, filter: 'all' }],
  },
  {
    id: 'discover_bc',
    name: 'Curio Hawker',
    ...
    attack: 2,
    health: 2,
    battlecry: [{ kind: 'discover', pool: 'minion' }],
  },
]
...
export const fixtureTreasures: TreasureDef[] = [
  ...
  {
    id: 'tr_fix_echo',
    name: 'Fixture Double Time',
    kind: 'passive',
    text: 'The first spell you cast each turn casts twice.',
    auras: [{ kind: 'firstSpellEachTurnTwice' }],
  },
  {
    id: 'tr_fix_grave_echo',
    name: 'Fixture Grave Echo',
    kind: 'passive',
    text: 'After a friendly Deathrattle minion dies, summon a 1/1 copy of it.',
    triggers: [
      {
        event: 'onFriendlyMinionDeath',
