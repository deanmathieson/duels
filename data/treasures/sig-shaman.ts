...
const tidePoolCard: CardDef = {
  ...
  cardClass: 'shaman',
  rarity: 'legendary',
  text: 'Summon a Healing Stream Effigy and a Wrath of Air Effigy. Draw a card.',
  spell: [
...
const ancestralSpiritsCard: CardDef = {
  ...
  cardClass: 'shaman',
  rarity: 'legendary',
  text: 'Give your minions +1/+1 and **Rush**. Add a 3/5 Lightning Spirit to your hand.',
  spell: [
...
export const shamanSignatureTreasures: TreasureDef[] = [
  ...
  },
  {
    ...
    name: 'Tide Pool',
    kind: 'signature',
    text: '(2) Spell. Summon a Healing Stream Effigy and a Wrath of Air Effigy. Draw a card.',
    card: tidePoolCard,
