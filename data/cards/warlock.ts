...
export const warlockCards: CardDef[] = [
   ...
   */
  {
    ...
    cardClass: 'warlock',
    rarity: 'rare',
    text: '**Charge**. **Battlecry:** Deal 4 damage to your hero.',
    attack: 5,
    health: 7,
    tribe: 'demon',
    keywords: ['charge'],
   ...
   */
  {
    ...
    cardClass: 'warlock',
    rarity: 'rare',
    text: '**Taunt**. **Battlecry:** Deal 3 damage to your hero. Gain an empty Mana Crystal.',
    attack: 3,
    health: 5,
    tribe: 'demon',
    keywords: ['taunt'],
   ...
   */
  {
    ...
    cardClass: 'warlock',
    rarity: 'common',
    text: '**Battlecry:** Deal 3 damage to ALL characters.',
    attack: 6,
    health: 6,
    tribe: 'demon',
   ...
   */
  {
    ...
    cardClass: 'warlock',
    rarity: 'legendary',
    text: '**Battlecry:** Deal 3 damage to your hero. Draw 3 cards.',
    attack: 5,
    health: 5,
    tribe: 'demon',
    battlecry: [
   ...
   */
  {
    ...
    cardClass: 'warlock',
    rarity: 'legendary',
    text: '**Battlecry:** Deal 5 damage to ALL characters. Give your hero +5 Attack this turn.',
    attack: 3,
    health: 15,
    tribe: 'demon',
    battlecry: [
   ...
   */
  {
    ...
    cardClass: 'warlock',
    rarity: 'rare',
    text: '**Deathrattle:** Summon a 5/5 Void Terror.',
    attack: 3,
    health: 4,
    tribe: 'demon',
   ...
   */
  {
    ...
    cardClass: 'warlock',
    rarity: 'rare',
    text: '**Lifesteal**. **Battlecry:** Summon a 1/1 Imp.',
    attack: 5,
    health: 7,
    tribe: 'demon',
    keywords: ['lifesteal'],
