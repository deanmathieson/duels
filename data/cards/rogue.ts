...
export const rogueCards: CardDef[] = [
   ...
   */
  {
    ...
    cardClass: 'rogue',
    rarity: 'common',
    text: '**Battlecry:** Equip a 1/2 Dagger.',
    attack: 3,
    health: 2,
    tribe: 'pirate',
   ...
   */
  {
    ...
    cardClass: 'rogue',
    rarity: 'rare',
    text: '**Stealth.** **Deathrattle:** Summon two 1/1 Shadows with Stealth.',
    attack: 3,
    health: 4,
    tribe: 'none',
    keywords: ['stealth'],
   ...
   */
  {
    ...
    cardClass: 'rogue',
    rarity: 'epic',
    text: '**Rush.** **Battlecry:** Equip a 2/3 Blade.',
    attack: 3,
    health: 4,
    tribe: 'pirate',
    keywords: ['rush'],
   ...
   */
  {
    ...
    cardClass: 'rogue',
    rarity: 'legendary',
    text: '**Charge.** **Battlecry:** Gain +3/+3.',
    attack: 4,
    health: 4,
    tribe: 'none',
    keywords: ['charge'],
   ...
   */
  {
    ...
    cardClass: 'rogue',
    rarity: 'legendary',
    text: '**Battlecry:** Add 3 random spells to your hand.',
    attack: 5,
    health: 5,
    tribe: 'none',
   ...
   */
  {
    ...
    cardClass: 'rogue',
    rarity: 'rare',
    text: '**Battlecry:** Reduce the Cost of cards in your hand by (1).',
    attack: 4,
    health: 5,
    tribe: 'none',
   ...
   */
  {
    ...
    cardClass: 'rogue',
    rarity: 'legendary',
    text: '**Stealth.** **Battlecry:** Deal 2 damage to all enemies.',
    attack: 3,
    health: 9,
    tribe: 'none',
    keywords: ['stealth'],
