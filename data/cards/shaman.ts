...
export const shamanCards: CardDef[] = [
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'common',
    text: 'Summon a 1/1 Searing Totem and a 0/2 Stoneskin Totem with Taunt.',
    spell: [
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'rare',
    text: 'Summon two 2/3 Spirit Wolves with **Taunt**.',
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'free',
    text: 'Transform a minion into a 0/1 with **Taunt**.',
    targeted: true,
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'common',
    text: '**Battlecry:** Summon a 0/2 Stoneskin Totem with **Taunt**.',
    attack: 3,
    health: 4,
    tribe: 'totem',
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'epic',
    text: '**Taunt.** **Battlecry:** Gain 3 Armor.',
    attack: 5,
    health: 8,
    tribe: 'elemental',
    keywords: ['taunt'],
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'legendary',
    text: '**Charge, Windfury, Taunt, Divine Shield.**',
    attack: 3,
    health: 5,
    tribe: 'elemental',
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'legendary',
    text: '**Battlecry:** Deal 3 damage to all minions. After you play a minion, add a random Shaman spell to your hand.',
    attack: 5,
    health: 5,
    tribe: 'none',
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'rare',
    text: 'Deal 1 damage to all enemy minions. Summon a 1/1 Searing Totem.',
    spell: [
   ...
   */
  {
    ...
    cardClass: 'shaman',
    rarity: 'legendary',
    text: '**Battlecry:** Give your minions +1/+1. Summon a 2/3 Spirit Wolf with **Taunt**.',
    attack: 5,
    health: 5,
    tribe: 'none',
    battlecry: [
