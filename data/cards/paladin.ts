...
export const paladinCards: CardDef[] = [
  ...
  },
  {
    ...
    cardClass: 'paladin',
    rarity: 'common',
    text: '**Battlecry:** Summon a 1/1 Recruit.',
    attack: 4,
    health: 4,
    tribe: 'none',
  ...
  // -------------------------------------------------------------------------
  {
    ...
    cardClass: 'paladin',
    rarity: 'rare',
    text: "**Battlecry:** Set an enemy minion's Attack to 1.",
    attack: 3,
    health: 3,
    tribe: 'none',
    targeted: true,
  ...
  // -------------------------------------------------------------------------
  {
    ...
    cardClass: 'paladin',
    rarity: 'epic',
    text: '**Battlecry:** Give your other minions +2/+2.',
    attack: 2,
    health: 5,
    tribe: 'none',
  ...
  // -------------------------------------------------------------------------
  {
    ...
    cardClass: 'paladin',
    rarity: 'legendary',
    text: '**Battlecry:** Give your other minions +3/+3 and **Divine Shield**.',
    attack: 5,
    health: 9,
    tribe: 'none',
    battlecry: [
  ...
  // --- 3-cost additions ---
  {
    ...
    cardClass: 'paladin',
    rarity: 'epic',
    text: '**Battlecry:** Give a random friendly minion **Divine Shield**, and a random friendly minion **Taunt**.',
    attack: 2,
    durability: 3,
  ...
  // --- 5-cost additions ---
  {
    ...
    cardClass: 'paladin',
    rarity: 'rare',
    text: '**Battlecry:** Discover a spell. Restore 3 Health to your hero.',
    attack: 4,
    health: 4,
    tribe: 'none',
  ...
  },
  {
    ...
    cardClass: 'paladin',
    rarity: 'legendary',
    text: '**Rush. Divine Shield. Lifesteal.**',
    attack: 5,
    health: 8,
    tribe: 'beast',
  ...
  },
  {
    ...
    cardClass: 'paladin',
    rarity: 'legendary',
    text: '**Battlecry:** Summon two 1/1 Recruits, then give your minions **Divine Shield**.',
    attack: 5,
    health: 4,
    tribe: 'demon',
    keywords: ['divineShield'],
