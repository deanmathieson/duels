...
export const priestCards: CardDef[] = [
...

  {
    ...
    flavor: "The Priest prescribes it for fever, heartbreak, and whatever happened at the harvest dance.",
    targeted: true,
   ...
   */
  {
    ...
    flavor: "Entry the third in the Priest's book of petty grievances, between 'the Miller's tone' and 'whoever keeps watering the wine.'",
    targeted: true,
    targetFilter: 'allMinions',
    targetMaxAttack: 3,
...

  {
    ...
    flavor: "Digs them up cheaper than the sexton plants them. The Priest takes a finder's fee in both directions.",
    attack: 2,
    health: 3,
    tribe: 'none',
  ...
  },
  {
    ...
    flavor: "Third Sunday of the month, the Priest reads the list from the pulpit. Bring a cushion — thine runs long.",
  ...
  },
  {
    ...
    flavor: "The Priest blesses every barrel personally. Quality control, he calls it. Twice nightly.",
  ...
  },
  {
    ...
    flavor: "The Priest damns the entire front row on principle, then consults the ledger to see who can afford absolution.",
    spell: [
  ...
  /** Discover a spell from your class pool — flexible value. */
  {
    ...
    flavor: "The future lies at the bottom of the chalice. The Priest checks several times a night, for accuracy.",
  ...
  /** 3/1 Rush minion — cheap early aggression and trade tool. */
  {
    ...
    rarity: 'common',
    text: '**Rush**',
    flavor: "Asked for penance; the Priest, half asleep, said 'lay it on thick.' He has not stopped since Michaelmas.",
    attack: 3,
    health: 1,
    tribe: 'none',
    keywords: ['rush'],
   ...
   */
  {
    ...
    flavor: "The lame walked. The blind saw. The Priest took ten percent and called it a tithe on grace.",
   ...
   */
  {
    ...
    flavor: "Ten percent of the harvest or ten percent of thy teeth — the Priest lets every parishioner choose.",
    attack: 4,
    health: 5,
    tribe: 'none',
    targeted: true,
   ...
   */
  {
    ...
    flavor: "The churchyard's been full for a century, but the Priest always finds room for one more. Shovel's extra.",
    targeted: true,
    targetFilter: 'allMinions',
    spell: [
